...
teamdef_t teams[8] = {
{ .id = 0, .style = 0, .teamcolor = (0xFFFFFFFF), .difficulty = 0.1f,  .maxturnspeed = 0.8f, .teamname = "FROZEN THUNDER",   .teamshortname = "FZT", .logofilename = "rom://textures/ui/teams/fronzen.rgba32.sprite",  .modelfilename = "rom://models/celica/celica_white.t3dm", .voicenamefn = "voice/Team_FrozenThunder",},
{ .id = 1, .style = 1, .teamcolor = (0xFF0000FF), .difficulty = 0.09f, .maxturnspeed = 0.55f,.teamname = "FLAMING WHEELS",   .teamshortname = "FLW", .logofilename = "rom://textures/ui/teams/flaming.rgba32.sprite",  .modelfilename = "rom://models/celica/celica_red.t3dm", .voicenamefn = "voice/Team_FlamingWheels",},
{ .id = 2, .style = 0, .teamcolor = (0x808080FF), .difficulty = 0.11f, .maxturnspeed = 0.7f, .teamname = "STEEL REBELS",     .teamshortname = "STR", .logofilename = "rom://textures/ui/teams/steel.rgba32.sprite",    .modelfilename = "rom://models/celica/celica_gray.t3dm", .voicenamefn = "voice/Team_SteelRebels",},
...
{ .id = 7, .style = 0, .teamcolor = (0xff5820FF), .difficulty = 0.13f, .maxturnspeed = 1.0f, .teamname = "SKILLED ALL-STARS",.teamshortname = "SKA", .logofilename = "rom://textures/ui/teams/allstars.rgba32.sprite", .modelfilename = "rom://models/celica/celica_orange.t3dm", .voicenamefn = "voice/Team_SkilledAllstars",},
};
