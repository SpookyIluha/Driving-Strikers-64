...
mapinfo_t maps[6] = {
    {   .name = "BLUE SKY BEACH", 
        ...
        .musicfn = "3_beach",
        .voicenamefn = "Stadium_BlueSkyBeach"
      },
    {   .name = "COBBLESTONE CASTLE", 
        ...
        .voicenamefn = "Stadium_CobblestoneCastle",
      },
    {   .name = "MOON LIGHT CITY", 
        ...
        .voicenamefn = "Stadium_MoonLightCity",
      },
    {   .name = "RED HOT ROCKS", 
        ...
        .voicenamefn = "Stadium_RedHotRocks",
      },
    {   .name = "LAPLAND VILLAGE", 
        ...
        .hdr.enabled = true, .hdr.tonemappingaverage = 0.5,
        .voicenamefn = "Stadium_LaplandVillage",
      },
    { .name = "RANDOM", 
